...
data class TrackResultEntity(
    ...
    val medianRmsDb: Double = 0.0,
    val dynamicRange: Double = 0.0,
    val drRating: Int = 0,
    val isBrickwalled: Boolean = false,
    ...
    fun toTrackResult(): TrackResult = TrackResult(
        ...
        qualityResult = QualityResult(
            ...
            clippedSamplesCount = clippedSamplesCount,
    ...
    companion object {
        fun fromTrackResult(result: TrackResult): TrackResultEntity = TrackResultEntity(
            ...
            medianRmsDb = result.qualityResult?.medianRmsDb ?: 0.0,
            dynamicRange = result.qualityResult?.dynamicRange ?: 0.0,
            drRating = result.qualityResult?.drRating ?: 0,
            isBrickwalled = result.qualityResult?.isBrickwalled ?: false,
